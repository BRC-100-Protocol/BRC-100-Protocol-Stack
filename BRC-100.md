...
| p         | Protocol                                                     | Yes       | No          |
| op        | Operator                                                     | Yes       | No          |
| tick      | Ticker: 3,5-100, can only contain ASCII letters, digits, "_" and ":", ":" represents a child application | Yes       | No          |
